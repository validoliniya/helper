 ...
 */
final class Version20211031193729 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE timer (id INT AUTO_INCREMENT NOT NULL, task_id INT NOT NULL, temp_date DATETIME NOT NULL, time INT NOT NULL, UNIQUE INDEX UNIQ_6AD0DE1A8DB60186 (task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
